var StoreItemsSlider = {
  ...
  hide: function() {
    ...
    j$('.home img').attr('src',  j$('#video-container').attr('skin-url') + "images/store_icon-md.png");
  ...
  show: function() {
    ...
    j$('.home img').attr('src',  j$('#video-container').attr('skin-url') + 'images/home_hover-md.png');

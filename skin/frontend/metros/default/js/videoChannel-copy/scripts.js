...
var SpriteToolBar = {
  ...
  show: function(){
    ...
    $('.shareImg').addClass("shareImg-selected");
    $('.shareImg').removeClass("shareImg-not-selected");
    $('#sprite-list').show();
    SpriteToolBar.showing = true;
  },

  hide: function(){
    $('.shareImg').addClass("shareImg-not-selected");
    $('.shareImg').removeClass("shareImg-selected");

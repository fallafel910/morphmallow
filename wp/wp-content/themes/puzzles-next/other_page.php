...
<head>
  ...
  <link type="image/x-icon" href="../wp-content/themes/puzzles-next/images/favicon.png" rel="icon">
  <link type="image/x-icon" href="../wp-content/themes/puzzles-next/images/favicon.png" rel="shortcut icon">
  ...
  jQuery(function($, undefined){
    ...
    $(".holidays").click(function(event){
     ...
     jQuery(document).ready(function(){
      jQuery('#content .slider ul li.eco a').addClass('active-tab-block');
     })
...
<script>
    jQuery(document).ready(function(){
        jQuery(".photo-btn").click(function(){
            event.preventDefault();
            jQuery(".photo-holder").stop();
            jQuery(".photo-btn").stop();
            if(jQuery(".photo-holder").css('right')!='-301px'){
                jQuery(".photo-holder").animate({"right": "-301px"}, "slow");
            }else{
                jQuery(".photo-holder").animate({"right": "0"}, "slow");
            }
        });
		
        jQuery('.photo-holder,.offer-block').height(window.innerHeight-139);

    })
</script>
<div class="photo-holder">
    <a class="photo-btn"><img src="<?php echo get_template_directory_uri(); ?>/images/upload_bg.png" alt=""></a>
    <div class="offer-block"><div class='woobox-offer' data-offer='jdyzfn'></div></div>
</div>

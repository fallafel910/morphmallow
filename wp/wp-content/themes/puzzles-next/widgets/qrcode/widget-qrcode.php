...
class themerex_qrcode_widget extends WP_Widget {
	...
	function form($instance) {
		...
		wp_enqueue_style( 'widget-qrcode-style',  get_template_directory_uri() . '/widgets/qrcode/widget-qrcode-admin.css', array(), null );
		wp_enqueue_script('qrcode', get_template_directory_uri().'/widgets/qrcode/jquery.qrcode-0.6.0.min.js', array('jquery','jquery-ui-core','jquery-ui-tabs'), null, false);
		wp_enqueue_style('color-picker', get_template_directory_uri().'/js/colorpicker/colorpicker.css', array(), null);
		wp_enqueue_script('color-picker', get_template_directory_uri().'/js/colorpicker/colorpicker.js', array('jquery'),null,true);

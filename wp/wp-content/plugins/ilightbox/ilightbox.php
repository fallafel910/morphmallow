...
class iLightBox {
	...
	*/
	...
	function ilightbox_bindeds_footer(){
		...
		$str .= "var b=[],d=".(($globals) ? $globals : "{}").";a('[rel^=\"ilightbox[\"]').each(function(){a.inArray(a(this).attr(\"rel\"),b) === -1&&b.push(a(this).attr(\"rel\"))});a.each(b,function(b,c){a('[rel=\"'+c+'\"]').iLightBox(d)});";

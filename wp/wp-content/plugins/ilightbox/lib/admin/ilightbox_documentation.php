...
GROUPNAME = The name of grouped lightboxes</textarea>
				...
				<ul class="noBull clearfix">
					<li class="clearfix">
						<span class="counter">1.5.4:</span>
						<span class="description">
							<strong>Fixed:</strong> UI display issues on WordPress 3.5+.<br>
							<strong>Fixed:</strong> Shortcode generator button issue.<br>
							<strong>Fixed:</strong> Multiple link galleries.<br>
							<hr>
						</span>
					</li>
					<li class="clearfix">
